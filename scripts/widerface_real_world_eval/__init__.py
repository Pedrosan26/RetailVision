...
(baseline.pt, final.pt) against Haar cascade's already-documented
real-world detection rates (docs/model_evaluation.md) -- the detector
these two checkpoints were evaluated to potentially replace. Each
